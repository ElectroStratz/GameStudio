...
public class RobotInv : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        RobotUI = GameObject.FindGameObjectWithTag("RobotPanel");
        robotPanel = GameObject.FindGameObjectWithTag("RobotInv");
    ...
    private void CreateSlots()
    {
        for (int i = 0; i < inventorySize; i++)
        {
            var slot = Instantiate(inventorySlot, robotPanel.transform);
            slot.transform.parent = robotPanel.transform;
